...
public class WSRequest {
    public static void main(String[] args) throws Exception {
        ...
        body.addChildElement("exampleElement").setValue("exampleValue");

        // Convert SOAPMessage to Document
        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        factory.setNamespaceAware(true);
        DocumentBuilder builder = factory.newDocumentBuilder();
        Document soapDocument = builder.parse(soapMessage.getSOAPPart().getContent());
        ...
        signature.setUserInfo(keyAlias, keystorePassword); // Use retrieved alias and password
